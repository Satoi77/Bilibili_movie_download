...
// 「下载中」页面展示的任务状态范围；completed 属于「已完成」页面，批量删除时不得波及
export const ACTIVE_TASK_STATUSES = ['pending', 'downloading', 'paused', 'failed'];
export function isActiveTask(t) {
  return !!t && ACTIVE_TASK_STATUSES.includes(t.status);
}
